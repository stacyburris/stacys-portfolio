...
- Created a two page profile with Gatsby templates
...
- Notes on deploying Gatsby to Netlify:
- **In terminal**
  1. Finish all changes to code base
  2. Make sure that codebase is in the root of repo
  3. $`gatsby build`
     3.5 optional) $`gatsby serve` (will allow you to see final render on local host: 9000
  4. Push up to GitHub
  5. Push to main
- **Netlify**
  1. Link Netlify to GitHub
  2. Select Repo to deploy
